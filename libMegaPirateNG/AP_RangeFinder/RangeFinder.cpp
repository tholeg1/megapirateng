...
int RangeFinder::read()
{
    ...
    if( _ap_adc != NULL ){
		...
		// JoeBarTeam : Ch_raw not functional, replaced by this 
		raw_value = _ap_adc->Ch(AP_RANGEFINDER_PITOT_TUBE_ADC_CHANNEL) ;  // values from ADC are twice as big as you'd expect
		//temp_dist = raw_value;
