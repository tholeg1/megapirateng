...
//
const char* AP_GPS_Ublox_i2c::_ublox_init_string[]  =
...
//
const char AP_GPS_Ublox_i2c::_gprmc_string[] PROGMEM = "GPRMC";
const char AP_GPS_Ublox_i2c::_gpgga_string[] PROGMEM = "GPGGA";
const char AP_GPS_Ublox_i2c::_gpvtg_string[] PROGMEM = "GPVTG";
...
// Constructors ////////////////////////////////////////////////////////////////
AP_GPS_Ublox_i2c::AP_GPS_Ublox_i2c(Stream *s) :
	GPS(s)
{
}

// Public Methods //////////////////////////////////////////////////////////////
void AP_GPS_Ublox_i2c::init(void)
{
	Wire.begin();
...
bool AP_GPS_Ublox_i2c::read(void)
{
	int numc;
	bool parsed = false;
...
bool AP_GPS_Ublox_i2c::_decode(char c)
{
...
// internal utilities
//
int AP_GPS_Ublox_i2c::_from_hex(char a)
{
	if (a >= 'A' && a <= 'F')
		return a - 'A' + 10;
	else if (a >= 'a' && a <= 'f')
...
unsigned long AP_GPS_Ublox_i2c::_parse_decimal()
{
	char *p = _term;
...
unsigned long AP_GPS_Ublox_i2c::_parse_degrees()
{
	char *p, *q;
	uint8_t deg = 0, min = 0;
...
bool AP_GPS_Ublox_i2c::_term_complete()
{
